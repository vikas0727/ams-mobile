 ...
 * that missed a STOP command from pushing frames at a panel nobody has open — and it reacts on the
 * next frame rather than at the next heartbeat, which can be a minute away.
 */
@Serializable
